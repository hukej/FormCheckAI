//#region node_modules/@mediapipe/pose/pose.js
(function() {
	"use strict";
	var x;
	function aa(a) {
	...
	z("Promise", function(a) {
		...
		b.prototype.I = function(f) {
			if (f === this) this.m(/* @__PURE__ */ new TypeError("A Promise cannot resolve to itself"));
		...
		b.prototype.D = function() {
			...
			"function" === typeof f ? f = new f("unhandledrejection", { cancelable: !0 }) : "function" === typeof h ? f = new h("unhandledrejection", { cancelable: !0 }) : (f = y.document.createEvent("CustomEvent"), f.initCustomEvent("unhandledrejection", !1, !0, f));
			f.promise = this;
			f.reason = this.j;
			return k(f);
		};
			...
			function k() {
				switch (l.i) {
					...
					case 2:
						h(l.j);
						break;
					default: throw Error("Unexpected state: " + l.i);
				}
			}
			var l = this;
	...
	function S(a, b) {
		P ? a[P] = b : void 0 !== a.A ? a.A = b : Object.defineProperties(a, { A: {
			value: b,
			configurable: !0,
			writable: !0,
			enumerable: !1
	...
	function ed() {
		return E(function(a) {
			switch (a.h) {
				case 1: return a.s = 2, D(a, WebAssembly.instantiate(ad), 4);
				case 4:
					a.h = 3;
					a.s = 0;
					break;
	...
	function nd(a) {
		void 0 === a && (a = 0);
		switch (a) {
			case 1: return "pose_landmark_full.tflite";
			case 2: return "pose_landmark_heavy.tflite";
			default: return "pose_landmark_lite.tflite";
		}
	}
	function od(a) {
		var b = this;
