...
const ACHIEVEMENTS_LIST = [
  { id: "001", title: "Król Przysiadów", desc: "Twoja technika przysiadu osiągnęła poziom elitarny.", req: "10 powtórzeń < 100°", icon: <Zap size={20} />, color: "text-sky-400", unlocked: false },
